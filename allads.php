...
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
    ...
    $id = $_SESSION["id"];
    $sql = "SELECT Car_ID,Car_Brand,Car_Model,Car_Year,Price,Picture FROM `used_car` WHERE User_ID=$id";
...
<head>
    ...
    <link href="css/allads.css" rel="stylesheet" />
...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-heading text-uppercase">All Ads</div>
                            ...
                            if (!empty($row))
                                foreach ($row as $rows) {
                                    ...
                                    <tr style="height:10%">
                                        ...
                                        <td><img src="<?php echo $rows['Picture']; ?>" alt="car" width="2" height="2"></td>
                                        <td>
                                            <?php echo $rows['Car_Brand']; ?>
                                        </td>
                                        <td>
                                            <?php echo $rows['Car_Model']; ?>
                                        </td>
                                        <td>
                                            <?php echo $rows['Car_Year']; ?>
                                        </td>
                                        <td>
                                            <?php echo $rows['Price']; ?>
                                        </td>
                                <td>
                                    <form method="post"action="allads.php?carid=<?= $rows['Car_ID']?> ">
                                        <input type='submit' class="btn btn-primary btn-xl text-uppercase"
                                               name="submit" value="Drop Ad" style="background-color: #3e6fad; width: 60%; height: 30%; font-size:0.9em;" />
                                    </form>
                                </td>
                                    </tr>
                                <?php $i++;
